...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      routerBetRecord () {
        this.routerControl({path: '/game/betRecord'})
      },
      routerDrawHis () {
        this.routerControl({path: `/game/drawHistory/${this.lotteryGroupCode}/${this.lotteryCode}/${this.lotteryId}`})
      },
      routerPanInfo () {
        this.routerControl({path: `/game/panInfo/${this.lotteryGroupCode}/${this.lotteryCode}/${this.lotteryId}`})
      },
      routerTodayTotalWin () {
        this.routerControl({path: '/game/todayTotalWin'})
      },
      routerCurrentBet () {
        this.routerControl({path: '/game/instantBetting'})
      },
      routerChart () {
        this.routerControl({path: `/game/trendChart/${this.lotteryGroupCode}/${this.lotteryName}/${this.lotteryId}`})
      },
