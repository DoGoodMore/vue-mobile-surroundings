...
import countDownTimer from './common/js/count-down-timer/index'
import { getToken, getMenus } from './common/js/cache'
          ...
          store.dispatch('getAccountInfo', getToken()).then(() => {
            ...
            if (menus && menus.length) {
              ...
              if (children && children.length) {
                ...
                next({path: `/game/${typeCode === 'ssc' ? 'ssc/kj' : typeCode}/${typeId}/${gameId}/${gameCode}/${gameName}`})
              }
            }
          }).catch(() => {
